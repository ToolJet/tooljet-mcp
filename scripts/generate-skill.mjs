...
- Items are authored, never defaulted: a \`Tabs\` without \`tabs\`, a \`Steps\` without \`steps\`, a \`Kanban\` without columns renders ToolJet's placeholder items beside your content.
