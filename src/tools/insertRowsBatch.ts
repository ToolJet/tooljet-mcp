...
export function insertRowsBatchTool(client: ToolJetClient): ToolDef {
  return {
    ...
    description:
      ...
      'retry completed seeds. Keep initial demo data representative and small; each table payload is capped at 40 rows so large ' +
      'fixtures must be split across compact calls.',
